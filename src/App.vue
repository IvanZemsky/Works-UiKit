...
<template>
   <div class="wrap">
      ...
      <ui-check-group v-model="value2" name="test">
         <ui-check-group-item value="11" label="11" name="1" id="1">11</ui-check-group-item>
         <ui-check-group-item value="22" label="22" name="2" id="2">22</ui-check-group-item>
         <ui-check-group-item value="33" label="33" name="3" id="3">33</ui-check-group-item>
      </ui-check-group>
   </div>
</template>
