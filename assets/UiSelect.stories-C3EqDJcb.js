import{d as y,B as q,C as M,v as e,D as N,q as z,s,o as w,x as m,E as U,t as V,T as C,y as $,p as B,z as I,b as P,A as T,u as f}from"./vue.esm-bundler-BOGk32Bt.js";import{_ as k}from"./UiButton-DSwb4RAA.js";import{_ as O}from"./UiSpacing-OCl5DJzN.js";import"./vue-router-xJp9MKPe.js";const c=y({__name:"UiSelect",props:q({placeholder:{},size:{default:"md"}},{modelValue:{required:!0},modelModifiers:{}}),emits:["update:modelValue"],setup(l){const o=l,a=M(l,"modelValue"),t=e(""),n=e(!1);N("ui-select",{size:o.size,model:a,selected:t,isOpen:n});const r=()=>{n.value=!n.value};return(i,d)=>(w(),z(O,{class:"ui-select",vertical:"",gap:"sm"},{default:s(()=>[m(k,{class:"ui-select__button",variant:"ghost",size:i.size,onclick:r},{default:s(()=>[U(V(t.value||i.placeholder),1)]),_:1},8,["size"]),m(C,{name:"ui-select-fade"},{default:s(()=>[$(m(O,{class:"ui-select__options",vertical:"",gap:"sm"},{default:s(()=>[B(i.$slots,"default")]),_:3},512),[[I,n.value]])]),_:3})]),_:3}))}});c.__docgenInfo={exportName:"default",displayName:"UiSelect",description:"",tags:{},props:[{name:"placeholder",description:"Placeholder - appears when no value is selected",required:!1,type:{name:"string"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiSelect/UiSelect.vue"]};const v=y({__name:"UiSelectOption",props:{value:{},label:{default:""}},setup(l){const o=l,{value:a,label:t}=o,{model:n,size:r,isOpen:i,selected:d}=P("ui-select",{size:"md",isOpen:e(!1),model:e(),selected:e("")});T(()=>{a===n.value&&(d.value=t)});const D=()=>{n.value=a,d.value=t,i.value=!1};return(E,F)=>(w(),z(k,{onclick:D,class:"ui-select__option",variant:"ghost",size:f(r)},{default:s(()=>[U(V(f(t)),1)]),_:1},8,["size"]))}});v.__docgenInfo={exportName:"default",displayName:"UiSelectOption",description:"",tags:{},props:[{name:"value",required:!0,type:{name:"unknown"}},{name:"label",required:!0,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiSelect/UiSelectOption.vue"]};const H={title:"Inputs/Select",component:c,tags:["autodocs"]},p={render:l=>({components:{UiSelect:c,UiSelectOption:v},setup(){const o=e("");return{args:l,value1:o}},template:`
