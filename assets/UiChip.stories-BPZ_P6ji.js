import{d as $,c as q,q as c,u as n,p as B,o as E}from"./vue.esm-bundler-DaCFxRb6.js";import{c as I}from"./clsx-B-dksMZM.js";import{u as D}from"./useWaveEffect-CfYcZ3Nk.js";import{S as N}from"./SearchOutlined-DH84yTP4.js";const a=$({__name:"UiChip",props:{variant:{default:"filled"},size:{default:"md"},color:{default:"neutral"},clickable:{type:Boolean,default:!1}},setup(e){const{isWaveActive:z,handleClick:o}=D(300);return(i,u)=>(E(),q("div",{class:B(n(I)("ui-chip",`variant-${i.variant}`,`color-${i.color}`,`size-${i.size}`,{clickable:i.clickable,wave:n(z)&&i.clickable})),onClick:u[0]||(u[0]=(...V)=>n(o)&&n(o)(...V))},[c(i.$slots,"start-icon"),c(i.$slots,"default"),c(i.$slots,"end-icon")],2))}});a.__docgenInfo={exportName:"default",displayName:"UiChip",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"union",elements:[{name:'"filled"'},{name:'"outlined"'}]},defaultValue:{func:!1,value:'"filled"'}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"color",required:!1,type:{name:"union",elements:[{name:'"primary"'},{name:'"secondary"'},{name:'"neutral"'}]},defaultValue:{func:!1,value:'"neutral"'}},{name:"clickable",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],slots:[{name:"start-icon"},{name:"default"},{name:"end-icon"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiChip/UiChip.vue"]};const P={component:a,title:"Data display/Chip",tags:["autodocs"]},t={render:e=>({components:{UiChip:a},setup(){return{args:e}},template:`
         ...
         </div>`})},p={render:e=>({components:{UiChip:a,SearchOutlined:N},setup(){return{args:e}},template:`
         <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 1rem ">
            <ui-chip>
...
}`,...(x=(y=p.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var w,S,b;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UiChip
    },
...
}`,...(b=(S=l.parameters)==null?void 0:S.docs)==null?void 0:b.source}}};var k,O,U;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UiChip
    },
