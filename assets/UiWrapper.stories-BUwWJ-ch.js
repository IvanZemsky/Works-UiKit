import{d as o,c as p,o as u,p as m,l}from"./vue.esm-bundler-BOGk32Bt.js";const e=o({__name:"UiWrapper",props:{paddings:{default:"x"}},setup(a){return(r,d)=>(u(),p("div",{class:l(["ui-wrapper",`paddings-${r.paddings}`])},[m(r.$slots,"default")],2))}});e.__docgenInfo={exportName:"default",displayName:"UiWrapper",description:"",tags:{},props:[{name:"paddings",required:!1,type:{name:"union",elements:[{name:'"x"'},{name:'"y"'},{name:'"both"'}]},defaultValue:{func:!1,value:'"x"'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiWrapper/UiWrapper.vue"]};const g={component:e,title:"Layout/Wrapper",tags:["autodocs"]},i={render:a=>({components:{UiWrapper:e},setup(){return{args:a}},template:`
