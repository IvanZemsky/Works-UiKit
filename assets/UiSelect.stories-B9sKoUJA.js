import{d as y,m as M,j as N,I as e,J as q,x as z,y as s,o as w,B as m,L as U,t as V,T as C,l as I,z as $,H as B,a as L,C as P,u as f}from"./vue.esm-bundler-BYAC-X9_.js";import{_ as k}from"./UiButton-cugExzWx.js";import{_ as O}from"./UiSpacing-N5mcTZWi.js";import"./vue-router-CXlkMNkf.js";const c=y({__name:"UiSelect",props:M({placeholder:{},size:{default:"md"}},{modelValue:{required:!0},modelModifiers:{}}),emits:["update:modelValue"],setup(l){const o=l,a=N(l,"modelValue"),t=e(""),n=e(!1);q("ui-select",{size:o.size,model:a,selected:t,isOpen:n});const r=()=>{n.value=!n.value};return(i,d)=>(w(),z(O,{class:"ui-select",vertical:"",gap:"sm"},{default:s(()=>[m(k,{class:"ui-select__button",variant:"ghost",size:i.size,onclick:r},{default:s(()=>[U(V(t.value||i.placeholder),1)]),_:1},8,["size"]),m(C,{name:"ui-fade-vertical"},{default:s(()=>[I(m(O,{class:"ui-select__options",vertical:"",gap:"sm"},{default:s(()=>[$(i.$slots,"default")]),_:3},512),[[B,n.value]])]),_:3})]),_:3}))}});c.__docgenInfo={exportName:"default",displayName:"UiSelect",description:"",tags:{},props:[{name:"placeholder",description:"Placeholder - appears when no value is selected",required:!1,type:{name:"string"}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiSelect/UiSelect.vue"]};const v=y({__name:"UiSelectOption",props:{value:{},label:{default:""}},setup(l){const o=l,{value:a,label:t}=o,{model:n,size:r,isOpen:i,selected:d}=L("ui-select",{size:"md",isOpen:e(!1),model:e(),selected:e("")});P(()=>{a===n.value&&(d.value=t)});const D=()=>{n.value=a,d.value=t,i.value=!1};return(T,j)=>(w(),z(k,{onclick:D,class:"ui-select__option",variant:"ghost",size:f(r)},{default:s(()=>[U(V(f(t)),1)]),_:1},8,["size"]))}});v.__docgenInfo={exportName:"default",displayName:"UiSelectOption",description:"",tags:{},props:[{name:"value",required:!0,type:{name:"unknown"}},{name:"label",required:!0,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiSelect/UiSelectOption.vue"]};const A={title:"Inputs/Select",component:c,tags:["autodocs"]},p={render:l=>({components:{UiSelect:c,UiSelectOption:v},setup(){const o=e("");return{args:l,value1:o}},template:`
...
}`,...(x=(S=u.parameters)==null?void 0:S.docs)==null?void 0:x.source}}};const G=["Default","Sizes"];export{p as Default,u as Sizes,G as __namedExportsOrder,A as default};
