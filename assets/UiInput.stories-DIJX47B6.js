import{d as C,u as $,c as u,g as k,a as N,f as q,m as G,n as P,j as l,k as A,o as d}from"./vue.esm-bundler-CviTMTQO.js";import{c as B}from"./clsx-B-dksMZM.js";import{S as o}from"./SearchOutlined-B8iNvvoD.js";const b={key:0,class:"ui-input__icon-wrap"},t=C({inheritAttrs:!1,__name:"UiInput",props:{variant:{default:"outlined"},size:{default:"md"},color:{default:"primary"},modelValue:{}},setup(e){const{class:O,style:V,...U}=$();return(n,p)=>(d(),u("div",{class:A(l(B)("ui-input",`variant-${n.variant}`,`size-${n.size}`,`color-${n.color}`,l(O))),style:P(l(V))},[n.$slots.icon?(d(),u("div",b,[q(n.$slots,"icon")])):k("",!0),N("input",G(U,{type:"text",onInput:p[0]||(p[0]=_=>n.$emit("update:modelValue",_.target.value))}),null,16)],6))}});t.__docgenInfo={exportName:"default",displayName:"UiInput",description:"",tags:{},props:[{name:"variant",description:"Vaiant of input",tags:{default:[{description:"'outlined'",title:"default"}],type:[{title:"type",description:`'outlined' | "ghost"`}]},required:!1,type:{name:"union",elements:[{name:'"outlined"'},{name:'"ghost"'}]},defaultValue:{func:!1,value:'"outlined"'}},{name:"size",description:"Size of input",tags:{default:[{description:"'md'",title:"default"}],type:[{title:"type",description:"'sm' | 'md' | 'lg'"}]},required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"color",description:"Color of input",tags:{default:[{description:"'primary'",title:"default"}],type:[{title:"type",description:"'primary' | 'secondary'"}]},required:!1,type:{name:"union",elements:[{name:'"primary"'},{name:'"secondary"'}]},defaultValue:{func:!1,value:'"primary"'}},{name:"modelValue",required:!1,type:{name:"string"}}],events:[{name:"update:modelValue"}],slots:[{name:"icon"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiInput/UiInput.vue"]};const j={title:"Text Input",component:t,tags:["autodocs"]},a={render:e=>({components:{UiInput:t},setup(){return{args:e}},template:`
      ...
      `})};var m,c,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UiInput
    },
...
}`,...(g=(c=a.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var f,y,h;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UiInput,
      SearchOutlined
...
}`,...(I=(S=i.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};var z,w,x;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UiInput,
      SearchOutlined
...
}`,...(x=(w=s.parameters)==null?void 0:w.docs)==null?void 0:x.source}}};const D=["Variant","Color","Icon","Size"];export{r as Color,i as Icon,s as Size,a as Variant,D as __namedExportsOrder,j as default};
