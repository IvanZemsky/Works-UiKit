import{d as t,x as _,z as v,H as y,v as g,q as G,l as U,o as l,c as I,k as h,s as k,t as V,b as w,y as $,j as q,u as a}from"./vue.esm-bundler-BRF8bUT-.js";import{_ as C}from"./UiSpacing-CXZ48G8P.js";import{_ as S}from"./UiRadio-DMLmqClZ.js";import"./vue-router-CFPU2mzG.js";const N={key:0,class:"ui-radio-group__title"},u=t({__name:"UiRadioGroup",props:_({size:{default:"md"},title:{default:""},name:{default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(i){const r=i,s=v(i,"modelValue");return y("ui-radio-group",{size:r.size,name:r.name,model:s}),(e,o)=>(l(),g(C,{class:U(["ui-radio-group",`size-${e.size}`]),gap:e.size,vertical:""},{default:G(()=>[e.title?(l(),I("p",N,V(e.title),1)):h("",!0),k(e.$slots,"default")]),_:3},8,["class","gap"]))}});u.__docgenInfo={exportName:"default",displayName:"UiRadioGroup",description:"",tags:{},props:[{name:"size",description:"sm, md, lg",required:!1,type:{name:"TSIndexedAccessType"},defaultValue:{func:!1,value:'"md"'}},{name:"title",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"name",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiRadioGroup/UiRadioGroup.vue"]};const c=t({__name:"UiRadioGroupItem",props:{size:{},label:{}},setup(i){const{size:r,name:s,model:e}=w("ui-radio-group",{size:"md",name:"",model:$()}),{value:o,id:z}=q(),x=z||R(),f=()=>{e.value=o};function R(){return`${s}-${o}`}return(b,B)=>(l(),g(S,{size:a(r),name:a(s),id:a(x),value:a(o),label:b.label,checked:a(e)===a(o),onChange:f},null,8,["size","name","id","value","label","checked"]))}});c.__docgenInfo={exportName:"default",displayName:"UiRadioGroupItem",description:"",tags:{},props:[{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]}},{name:"label",required:!1,type:{name:"string"}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiRadioGroup/UiRadioGroupItem.vue"]};const E={title:"Inputs/Radio Group",component:u,tags:["autodocs"]},d={render:i=>({components:{UiRadioGroup:u,UiRadioGroupItem:c},setup(){return{args:i}},template:`
