import{_ as k}from"./UiSpacing-BOT-jzrt.js";import{d as g,x as G,y as v,l as C,z as y,s as f,v as I,q as S,u as c,o as t,c as V,m as $,k as q,t as M,e as N,r as x}from"./vue.esm-bundler-2rTkCq1z.js";import{c as A}from"./clsx-B-dksMZM.js";import{_ as w}from"./UiCheck-CAFnsFcU.js";const B={key:0,class:"ui-check-group__title"},b=g({__name:"UiCheckGroup",props:G({size:{default:"md"},title:{default:""}},{modelValue:{required:!0,default:[]},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const r=a,i=v(a,"modelValue"),{name:u}=C();return y("ui-check-group",{size:r.size,name:u,model:i}),(e,o)=>(t(),f(k,{class:S(c(A)("ui-check-group",`size-${e.size}`)),gap:e.size,vertical:""},{default:I(()=>[e.title?(t(),V("p",B,M(e.title),1)):$("",!0),q(e.$slots,"default")]),_:3},8,["class","gap"]))}});b.__docgenInfo={exportName:"default",displayName:"UiCheckGroup",description:"",tags:{},props:[{name:"size",required:!1,type:{name:"TSIndexedAccessType"},defaultValue:{func:!1,value:'"md"'}},{name:"title",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiCheckGroup/UiCheckGroup.vue"]};const l=g({__name:"UiCheckGroupItem",props:{size:{},label:{}},setup(a){const{size:r,model:i,name:u}=N("ui-check-group",{size:"md",name:"",model:x([])}),{value:e,id:o}=C(),z=o||U(),_=()=>{i.value.includes(e)?i.value=i.value.filter(p=>p!==e):i.value.push(e)};function U(){return`${u}-${e}`}return(n,p)=>(t(),f(w,{size:c(r),checked:c(i).includes(c(e)),label:n.label,id:c(z),name:c(u),onChange:_},null,8,["size","checked","label","id","name"]))}});l.__docgenInfo={exportName:"default",displayName:"UiCheckGroupItem",description:"",tags:{},props:[{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]}},{name:"label",required:!1,type:{name:"string"}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiCheckGroup/UiCheckGroupItem.vue"]};const P={title:"Inputs/Check Group",component:l,tags:["autodocs"]},s={render:a=>({components:{UiCheckGroupItem:l,UiCheckGroup:b,UiSpacing:k},setup(){return{args:a}},template:`
         <ui-spacing gap="lg">
