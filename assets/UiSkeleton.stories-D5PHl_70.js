import{d as h,c as z,l as U,o as S}from"./vue.esm-bundler-BOGk32Bt.js";import{_ as l}from"./UiButton-DSwb4RAA.js";import"./vue-router-xJp9MKPe.js";const n=h({__name:"UiSkeleton",props:{variant:{default:"rectangle"},animation:{default:"wave"},size:{default:"md"}},setup(e){const y=e.animation!=="none";return(r,_)=>(S(),z("div",{class:U(["ui-skeleton",`variant-${r.variant}`,`size-${r.size}`,{[`animation-${r.animation}`]:y}])},null,2))}});n.__docgenInfo={exportName:"default",displayName:"UiSkeleton",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"union",elements:[{name:'"rectangle"'},{name:'"disc"'}]},defaultValue:{func:!1,value:'"rectangle"'}},{name:"animation",required:!1,type:{name:"union",elements:[{name:'"wave"'},{name:'"pulse"'},{name:'"none"'}]},defaultValue:{func:!1,value:'"wave"'}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiSkeleton/UiSkeleton.vue"]};const q={component:n,title:"Data Display/Skeleton",tags:["autodocs"]},i={render:e=>({components:{UiSkeleton:n,UiButton:l},setup(){return{args:e}},template:`
