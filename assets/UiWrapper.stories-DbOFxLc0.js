import{d as o,c as p,o as u,k as m,q as l,u as d}from"./vue.esm-bundler-2rTkCq1z.js";import{c}from"./clsx-B-dksMZM.js";const e=o({__name:"UiWrapper",props:{paddings:{default:"x"}},setup(a){return(r,g)=>(u(),p("div",{class:l(d(c)("ui-wrapper",`paddings-${r.paddings}`))},[m(r.$slots,"default")],2))}});e.__docgenInfo={exportName:"default",displayName:"UiWrapper",description:"",tags:{},props:[{name:"paddings",required:!1,type:{name:"union",elements:[{name:'"x"'},{name:'"y"'},{name:'"both"'}]},defaultValue:{func:!1,value:'"x"'}}],slots:[{name:"default"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiWrapper/UiWrapper.vue"]};const q={component:e,title:"Layout/Wrapper",tags:["autodocs"]},i={render:a=>({components:{UiWrapper:e},setup(){return{args:a}},template:`
