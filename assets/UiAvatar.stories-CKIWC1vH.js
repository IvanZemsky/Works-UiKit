import{d as M,G as h,z as S,p as I,q as $,n as A,u as a,l as U,o as s,c as o,k as g,t as x}from"./vue.esm-bundler-Bfxd_V-S.js";import{R as D}from"./vue-router-Bm2IpmDu.js";const V={key:0},q=["src","alt"],C={key:2},u=M({__name:"UiAvatar",props:{as:{default:"div"},size:{default:"md"},src:{default:""},alt:{default:""}},setup(n){const i=n,{alt:d,src:t}=i,r=h(!1),p=k(d),_=i.as==="router-link"?D:i.as;S(()=>{if(t){const e=new Image;e.onload=f,e.onerror=c,e.src=t}});const f=()=>{r.value=!0},c=()=>{r.value=!1};function k(e){return e.length===2?e:e.split(" ").map((v,L)=>L<2?v[0].toUpperCase():null).join("")}return(e,v)=>(s(),I(a(_),{class:U(["ui-avatar",`size-${e.size}`]),style:A(`background-image: ${a(t)&&!r.value?"none":`url(${a(t)})`}`)},{default:$(()=>[!a(t)&&!r.value?(s(),o("span",V,x(a(p)),1)):g("",!0),a(t)&&r.value?(s(),o("img",{key:1,src:a(t),alt:a(d),onLoad:f,onError:c},null,40,q)):a(t)&&!r.value?(s(),o("span",C,x(a(p)),1)):g("",!0)]),_:1},8,["class","style"]))}});u.__docgenInfo={exportName:"default",displayName:"UiAvatar",description:"",tags:{},props:[{name:"as",required:!1,type:{name:"union",elements:[{name:'"router-link"'},{name:"TSTypeOperator"}]},defaultValue:{func:!1,value:'"div"'}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"src",description:"Link to an image",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"alt",description:"One or two letters. If two or more words are passed, alt will be the first letters of the first two words.",required:!1,type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiAvatar/UiAvatar.vue"]};const m=""+new URL("male-1-BaQLhsf9.jpg",import.meta.url).href,E={component:u,title:"Data display/Avatar",tags:["autodocs"]},l={render:n=>({components:{UiAvatar:u},setup(){return{args:n}},template:`
...
}`,...(z=(w=l.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const G=["Default"];export{l as Default,G as __namedExportsOrder,E as default};
