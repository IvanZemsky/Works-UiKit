import{d as g,s as y,v as h,p as v,u as e,o as w,q as r}from"./vue.esm-bundler-DaCFxRb6.js";import{R as _}from"./vue-router-2jzTnSoH.js";import{c as x}from"./clsx-B-dksMZM.js";const t=g({__name:"UiLink",props:{as:{default:"router-link"},size:{default:"md"},color:{default:"primary"},hover:{default:"underline"},weight:{default:"400"}},setup(n){const u=n,{size:d,color:p,as:l,hover:f,weight:c}=u,k=l==="router-link"?_:l;return(s,L)=>(w(),y(e(k),{class:v(e(x)("ui-link",`size-${e(d)}`,`color-${e(p)}`,`hover-${e(f)}`,`weight-${e(c)}`))},{default:h(()=>[r(s.$slots,"start-icon"),r(s.$slots,"default"),r(s.$slots,"end-icon")]),_:3},8,["class"]))}});t.__docgenInfo={exportName:"default",displayName:"UiLink",description:"",tags:{},props:[{name:"as",required:!1,type:{name:"union",elements:[{name:'"button"'},{name:'"a"'},{name:'"router-link"'}]},defaultValue:{func:!1,value:'"router-link"'}},{name:"size",required:!1,type:{name:"union",elements:[{name:'"sm"'},{name:'"md"'},{name:'"lg"'}]},defaultValue:{func:!1,value:'"md"'}},{name:"color",required:!1,type:{name:"union",elements:[{name:'"primary"'},{name:'"secondary"'}]},defaultValue:{func:!1,value:'"primary"'}},{name:"hover",required:!1,type:{name:"union",elements:[{name:'"underline"'},{name:'"fade-dark"'},{name:'"fade-light"'}]},defaultValue:{func:!1,value:'"underline"'}},{name:"weight",required:!1,type:{name:"union",elements:[{name:'"400"'},{name:'"500"'},{name:'"600"'}]},defaultValue:{func:!1,value:'"400"'}}],slots:[{name:"start-icon"},{name:"default"},{name:"end-icon"}],sourceFiles:["D:/Programming/Vue/p-work-ui/src/components/UiLink/UiLink.vue"]};const U={component:t,title:"Data display/Link",tags:["autodocs"]},a={render:n=>({components:{UiLink:t},setup(){return{args:n}},template:`
